...
//set up game LVL 2
//--------------
void first_time_setuplvl2(Game * game) {
	gameovercounter = 0;
	game->score = 0;
...
//----------------------------------
//make character fallLVL2
//----------------------------------
void apply_gravitylvl2(Game * game) {
...
//----------------------------------
//where the game is processedLVL2
//----------------------------------
...
void first_time_setup(Game * game) {
	gameovercounter = 0;
	game->score = 0;
	game->platform_timer = create_timer(500);
	lives = 3;
	game->playing_time = create_timer(1000);
	game->tc = 0;
	game->minutes = 0;
...
//----------------------------------------------
 void display_game(Game *game) {
	...
	draw_formatted(13, screen_height()-1 - 1,"Level: %d",level);
...
bool main_menu(Game * game) {
	...
	draw_formatted(screen_width() / 3 + 6, screen_height() / 3 + 3,"LEVEL: %d", level);
